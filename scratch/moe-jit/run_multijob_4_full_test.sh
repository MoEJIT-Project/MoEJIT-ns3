...
echo "=========================================="
echo "Running FatTree 4-Job Fixed Probability Tests (Full Backoff Suite)"
echo "Logs will be saved to: $LOG_DIR"
echo "=========================================="

echo "| JobMode | Backoff | Probability | Avg Task Duration (ms) | Avg FCT (ms) | Avg Pkt Delay (ms) | Workload Makespan (s) |" > "$LOG_DIR/multijob_4_full_summary.csv"
...
do
    ...
    do
        ...
        echo "$CLEAN_RESULT" >> "$LOG_DIR/multijob_4_full_summary.csv"
    done
done

echo "=========================================="
echo "Full Tests Complete. Summary:"
cat "$LOG_DIR/multijob_4_full_summary.csv"
