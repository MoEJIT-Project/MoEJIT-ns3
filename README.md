...
### MoEJIT Project Additions
This repository contains the **MoEJIT (MoE Just-In-Time)** research project, which focuses on MoE (Mixture-of-Experts) training optimization.
...
*   **Directory**: `scratch/moe-jit/moe-traces/`
