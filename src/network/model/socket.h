...
using LocalDrainCallback = std::function<void(ns3::NS3NodeID, ns3::Address)>;
...
class Socket : public Object
{
  protected:
    ...
    bool m_local_blocked = false;
    LocalDrainCallback m_localDrainCallBack;
  public:
    void block(const LocalDrainCallback &ldcb)
    {
        // std::cout <<"blocking "  << std::endl;
        m_local_blocked = true;
        m_localDrainCallBack = ldcb;
        // std::cout <<"blocked:" << m_local_blocked << std::endl;
    }
    void unblock(){
        // std::cout <<"unblocking"  << std::endl;
        m_local_blocked = false;
        // std::cout <<"blocked:" << m_local_blocked << std::endl;
    }
  public:
    /**
